...
import { RxresourceServiceStoreComponent } from "./feature/rxresource-service-store/rxresource-service-store.component";
...
export const StateManagementRoutes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: RxresourceServiceStoreComponent,
      }
    ]
  }
]